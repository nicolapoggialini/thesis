...
from my_modeling_outputs import BaseModelOutputWithPastAndCrossAttentions, Seq2SeqLMOutput
...
class LongT5Attention(nn.Module):
    ...
    def forward(
        ...
        output_pre_attention_weights=False,
    ):
        """
        ...
        pre_attention_weights = scores.clone().detach() ### MY CHANGE ###
        ...
        if output_pre_attention_weights: ### MY CHANGE ###
            outputs = outputs + (pre_attention_weights,)
...
class LongT5LayerCrossAttention(nn.Module):
    ...
    def forward(
        ...
        attention_output = self.EncDecAttention(
            ...
            output_attentions=output_attentions,
            output_pre_attention_weights=output_pre_attention_weights,
        )
...
class LongT5Block(nn.Module):
    ...
    def forward(
        ...
        if do_cross_attention:
            ...
            # Keep cross-attention outputs and relative position weight
...
class LongT5Stack(LongT5PreTrainedModel):
    ...
    def forward(
        ...
        output_pre_attention_weights=None,
        ...
        output_pre_attention_weights = output_attentions if output_attentions is not None else self.config.output_attentions
        ...
        all_pre_attentions = () if (output_pre_attention_weights and self.is_decoder) else None
        ...
        for i, (layer_module, past_key_value) in enumerate(zip(self.block, past_key_values)):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                def create_custom_forward(module):
                    def custom_forward(*inputs):
                        return tuple(module(*inputs, use_cache, output_attentions, output_pre_attention_weights))
            ...
            if output_attentions:
                ...
                if self.is_decoder:
                    ...
                    if output_pre_attention_weights:
                      all_pre_attentions = all_pre_attentions + (layer_outputs[6],)
...
class LongT5ForConditionalGeneration(LongT5PreTrainedModel):
    ...
    def forward(
        ...
        use_cache: Optional[bool] = None,
        output_attentions: Optional[bool] = None,
        output_pre_attention_weights: Optional[bool] = None,
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
        ...
        return Seq2SeqLMOutput(
            ...
            decoder_attentions=decoder_outputs.attentions,
            cross_attentions=decoder_outputs.cross_attentions,
            pre_attentions=decoder_outputs.pre_attentions,
            encoder_last_hidden_state=encoder_outputs.last_hidden_state,
            encoder_hidden_states=encoder_outputs.hidden_states,
            encoder_attentions=encoder_outputs.attentions,
        )
